...
第二种类型的客户通常是相对容易识别的，因为我们知道谁从谁那里接收工作。
...
总之，需求和愿望代表了所谓"客户的声音"（Voice of Customer）（VoC）。从VoC来看，组织交付价值时必须给需求和愿望精炼和排优先级，以找到对于客户而言最重要的那些，CTQ方面的那些。在定义CTQs的时候，企业必须定义它们的关键内在属性。属性必须是可测量的。通过这种方式，客户期望转换成可测量的内部目标和活动。与客户的声音相关的CTQ和属性被称为CTQ树。
...
在精益中，过程是至关重要的。它们是我们用来为客户提供价值的工具。出于这个原因，我们将流程称为价值流。这两个概念是同义词，只有“价值”这个单词清楚地表明了这个过程的意图。价值流是一种特定的、可指定的操作链，它会导致产品或服务的创建，而产品或服务对产品或服务的接收者具有价值。

在正确的时间内，必须正确地按照正确的顺序执行动作，以便创建和交付价值。至关重要的是，必须依次执行这些操作，这样在步骤之间的延迟是最小的。在这种情况下，价值流具有流的特征，第三个精益原则。我们的目标是在客户提供触发器时启动价值流，从而使价值流成为第四个精益原则。